...
int main()
{
	...
	// ------------------------------------
	Shader ourShader("part_4/camera.vs", "part_4/camera.fs");
	...
	texture1 = readTextureJPG("resources/textures/container.jpg");
	texture2 = readTexturePNG("resources/textures/awesomeface.png");
